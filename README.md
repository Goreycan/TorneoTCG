...
## Pruebas Unitarias
El proyecto cuenta con pruebas unitarias implementadas con **JUnit 5 y Mockito**, alcanzando más del 80% de cobertura. Las pruebas siguen la estructura *Given-When-Then* validando la lógica de nego
